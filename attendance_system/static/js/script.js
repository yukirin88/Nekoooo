...
function updateAllPeriodsCharts(data) {
  document.getElementById('allPeriodsCharts').style.display = 'block';
  document.getElementById('sleepChart').style.display = 'none';
  
  createChart('dailyChart', data.daily, '日別睡眠時間');
  createChart('weeklyChart', data.weekly, '週別平均睡眠時間');
  createChart('monthlyChart', data.monthly, '月別平均睡眠時間');
}
