...
{% block content %}
<div class="container">
    <h2>{{ year }}年{{ month }}月　<a href="{{ url_for('index') }}" class="btn btn-primary">ホームに戻る</a></h2>
    ...
    <div class="calendar-nav mb-3">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#sleepGraphModal">
            <i class="fas fa-chart-line"></i> 睡眠グラフ
        </button>
    </div>
